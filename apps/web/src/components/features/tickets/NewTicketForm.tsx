...
export function NewTicketForm() {
  ...
  async function handleConfirmSubmit() {
    ...
    try {
      ...
      const result = await apiClient.post<CreateResponse>('/api/tickets/public', {
        name: v.name,
        email: v.email,
        subject: v.subject,
        ...
        <CardContent className="flex flex-col items-center gap-4 py-12 text-center">
          ...
          <div>
            ...
            <p className="mt-3 text-sm text-ink-muted">
              Enviamos um e-mail de confirmação. Em breve você receberá uma resposta.
            </p>
          </div>
            ...
            {step === 1 && (
              <div className="space-y-5">
                <div>
                  ...
                  <p className="text-sm text-ink-muted">Informe como podemos identificar você.</p>
                </div>
